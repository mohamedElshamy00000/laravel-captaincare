        ...
        <form action="{{ route("admin.cars.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <input class="form-control" type="file" name="license" value="{{ old('license', isset($car) ? $car->license : '') }}" id="formFile">
                    @error('license')
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <input class="form-control" type="file" name="photo" value="{{ old('photo', isset($car) ? $car->photo : '') }}" id="photo">
                    @error('photo')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
